...
const TransactionController = () => {
    ...
    const updateExpance = (row,fetchTransaction) => {
        dispatch(
            openModal({
                title: "Update Expance",
                component: <UpdateExpanceController row={row} fetchTransaction={fetchTransaction}/>,
                size: "sm"
            })
        )
        fetchTransaction();

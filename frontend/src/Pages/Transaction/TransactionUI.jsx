...
const TransactionUI = ({ loading, expanseLoading, date, setDate, search, setSearch, expanseData, filters, setFilters, addNewExpanceModal, updateExpance, AddCategory, categorydata, updateCategory, deleteCategory, deleteExpance, fetchTransaction }) => {
                                                ...
                                                <Grid sx={{ marginTop: "8px" }} item xs={1}>
                                                    ...
                                                    {isMenuVisible && currentExpenseItem == index && (
                                                        <Box sx={{ ...center, gap: "3px" }}>
                                                            <ButtonBase onClick={() => { updateExpance(row,fetchTransaction) }}>
                                                                <Update />
                                                            </ButtonBase>
                                                            <ButtonBase onClick={() => {
